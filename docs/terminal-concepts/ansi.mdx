...
- [Terminal Limitations](/terminal-concepts/limitations) - Important compatibility considerations
- [Text & Styling](/components/text) - Learn about text components and styling
