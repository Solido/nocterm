...
void main() {
  group('Builder', () {
    test('builds component from builder callback', () async {
      await testNocterm('basic builder', (tester) async {
    ...
    test('provides BuildContext to builder callback', () async {
      await testNocterm('builder context', (tester) async {
    ...
    test('can access inherited widgets through context', () async {
      await testNocterm('builder inherited access', (tester) async {
        await tester.pumpComponent(
          Container(
            width: 40,
            height: 5,
    ...
    test('rebuilds when parent rebuilds', () async {
      await testNocterm('builder rebuilds', (tester) async {
        var buildCount = 0;
    ...
    test('works nested inside other components', () async {
      await testNocterm('nested builder', (tester) async {
        await tester.pumpComponent(
          Container(
            width: 40,
            height: 10,
    ...
    test('can return complex component trees', () async {
      await testNocterm('complex builder output', (tester) async {
        await tester.pumpComponent(
          Container(
            width: 40,
            height: 10,
    ...
    test('visual development - builder in layout', () async {
      await testNocterm('visual builder demo', (tester) async {
        await tester.pumpComponent(
          Container(
            width: 50,
            height: 10,
