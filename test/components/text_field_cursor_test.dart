...
void main() {
  group('TextField Selection', () {
    test('selection should be visible when using Shift+Arrow keys', () async {
      await testNocterm('text selection rendering', (tester) async {
    ...
    test('Ctrl+A should select all text', () async {
      await testNocterm('select all functionality', (tester) async {
    ...
    test('typing should replace selected text', () async {
      await testNocterm('replace selection with typed text', (tester) async {
    ...
    test('visual selection highlighting', () async {
      await testNocterm('check selection background color', (tester) async {
